...
class Homogenus_infer(object):
    ...
    def predict_genders(self, images_indir, openpose_indir, images_outdir=None, openpose_outdir=None):
        '''
        Given a directory with images and another directory with corresponding openpose generated jsons will
        ...
        :param openpose_outdir: If given will dump the gendered openpose files in this directory. if not will augment the originals
        :return:
        '''
        import os, sys
        import json
